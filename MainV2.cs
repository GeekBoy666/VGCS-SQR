...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        private void MenuFlightData_Click(object sender, EventArgs e)
        {
            ...
            frmAddUser.Parent = splitContainer1.Panel1;
            splitContainer1.Panel1.Controls.Add(frmAddUser);
        ...
        public void MenuSetup_Click(object sender, EventArgs e)
        {
            if (Settings.Instance.GetBoolean("password_protect") == false)
            {
                ...
                splitContainer1.Panel1.Controls.Clear();
                GCSViews.ConfigurationView.InitialSetup frmAddUser = new GCSViews.ConfigurationView.InitialSetup();
        ...
        private void MenuTuning_Click(object sender, EventArgs e)
        {
            if (Settings.Instance.GetBoolean("password_protect") == false)
            {
                ...
                splitContainer1.Panel1.Controls.Clear();
                GCSViews.ConfigurationView.ParameterAdujust frmAddUser = new GCSViews.ConfigurationView.ParameterAdujust();
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            splitContainer1.SplitterDistance = splitContainer1.Width - splitContainer1.Width / 23;
